...
internal val drinksCategoryToEntityMapper: FunctionMapper<Category, CategoryEntity> by lazy {
    { CategoryEntity(key = it.strCategory) }
}

internal val drinksIngredientToEntityMapper: FunctionMapper<Ingredient, IngredientEntity> by lazy {
    { IngredientEntity(key = it.strIngredient1) }
}

internal val drinksToEntityMapper: FunctionMapper<Drink, DrinkEntity> by lazy {
    {
        DrinkEntity(
...
internal val cocktailInfoToEntityMapper: FunctionMapper<Cocktail, CocktailEntity> by lazy {
    {
        CocktailEntity(
            key = it.idDrink,
            strDrink = it.strDrink,
