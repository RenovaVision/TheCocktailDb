...
import com.renovavision.thecocktaildb.data.entities.CocktailDetailsEntity.Companion.TABLE_NAME
import com.squareup.moshi.Json
import com.squareup.moshi.JsonClass

@JsonClass(generateAdapter = true)
data class CocktailDetailsResponse(
    val drinks: List<CocktailDetailsEntity>
)

@JsonClass(generateAdapter = true)
@Entity(tableName = TABLE_NAME)
data class CocktailDetailsEntity(
    @PrimaryKey
    val idDrink: Int,
    val strDrink: String,
    ...
    companion object {
        const val TABLE_NAME = "CocktailDetails"
    }
}